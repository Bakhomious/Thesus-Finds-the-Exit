...
class ParameterizedPositionTest {
    ...
    void getPosition(Position position) {
        assertPosition(position.row() - 1, position.col(), position.getPosition(MoveDirection.UP));
        assertPosition(position.row(), position.col() + 1, position.getPosition(MoveDirection.RIGHT));
        assertPosition(position.row() + 1, position.col(), position.getPosition(MoveDirection.DOWN));
        assertPosition(position.row(), position.col() - 1, position.getPosition(MoveDirection.LEFT));
    }
